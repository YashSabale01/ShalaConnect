...
import {
  BookOpen, Plus, Trash2, Edit2, Image, FileText,
  Calendar, MapPin, Tag, Upload, AlertCircle
} from 'lucide-react'
...
export default function EventsPage() {
  ...
  const [uploading,   setUploading]   = useState(null) // { id, type: 'media'|'report' }
  const [submitting,  setSubmitting]  = useState(false)
  const mediaRef = useRef(); const reportRef = useRef()
